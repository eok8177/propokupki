    ...
    <div class="block">
        ...
        <div class="body">
            ...
            <form method="POST" action="{{ route('register') }}">
                @csrf
            <input id="name" type="text" placeholder="Ім'я" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" required autofocus>
                ...
                @endif
                <input id="password-confirm" placeholder="Повторити пароль" type="password" class="form-control" name="password_confirmation" required>
